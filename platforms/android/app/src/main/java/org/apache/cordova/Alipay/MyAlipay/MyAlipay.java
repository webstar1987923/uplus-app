package org.apache.cordova.Alipay.MyAlipay;
 ...
 */
public class MyAlipay extends CordovaPlugin {
    ...
    private void pay(String orderInfo, final CallbackContext callbackContext) {
